 ...
 * @LastEditTime: 2020-11-11 11:17:32
    ...
    <div class="pager-inner">
      ...
      <div class="pageSizes mr-10">
        ...
        <div class="size" ref="size" :class="{ sizeActive: sizeListVisable }" @click="toggleShowSizeList">
          ...
          <!-- <i class="iconfont iconxiajiantou ml-5 trans" :class="{ transTop: sizeListVisable }"></i> -->
      ...
      <div v-if="pageNum > 6" class="pagesWrap mr-10">
        <div class="jumpPrevBtn" :class="{ btnDisabled: pagerConfig.currentPage === 1 }" @click="onCLickJumpPrevBtn"><i class="icon-fast-backward"></i></div>
        <div class="prevBtn" :class="{ btnDisabled: pagerConfig.currentPage === 1, br: pagerConfig.currentPage != 1 }" @click="onCLickPrevBtn"><i class="icon-angle-left"></i></div>
        ...
        <div class="nextBtn" :class="{ btnDisabled: pagerConfig.currentPage === pageNum }" @click="onCLickNextBtn"><i class="icon-angle-right"></i></div>
        <div class="jumpNextBtn" :class="{ btnDisabled: pagerConfig.currentPage === pageNum }" @click="onCLickJumpNextBtn"><i class="icon-fast-forward"></i></div>
      </div>
